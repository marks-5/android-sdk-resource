...
ENV ANDROID_SDK_PACKAGES="build-tools;26.0.2 platforms;android-26 platform-tools extras;android;m2repository extras;google;m2repository extras;google;google_play_services"
